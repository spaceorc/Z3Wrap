...
public class Z3BitVecExprResizeTests
{
    ...
    public void UnsignedResize_AllVariations_ReturnsExpectedResult(
        int value,
        uint fromSize,
        uint toSize,
        int expectedResult
    ...
    [TestCase(
        ...
        16u,
        65408,
        Description = "Sign-extend -128 to 16-bit (-128 = 65408 in 16-bit)"
    )]
    ...
    public void SignedResize_AllVariations_ReturnsExpectedResult(
        int value,
        uint fromSize,
        uint toSize,
        int expectedResult
    ...
    )
    {
        ...
        var model = solver.GetModel();
        Assert.That(
            model.GetBitVec(result),
            Is.EqualTo(new BitVec(expectedResult, expectedToSize))
        );
    }
    ...
    public void Repeat_AllVariations_ReturnsExpectedResult(
        int value,
        uint originalSize,
        uint repeatCount,
        int expectedResult,
