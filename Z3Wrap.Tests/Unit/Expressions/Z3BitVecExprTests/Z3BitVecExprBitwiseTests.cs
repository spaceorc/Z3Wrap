    ...
    )
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(expected),
                "BitVec.And(BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextBitVec),
                Is.EqualTo(expected),
                "Context.And(BitVec, BitVec) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextRightBigInt),
                Is.EqualTo(expected),
                "Context.And(BitVec, BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextLeftBigInt),
                Is.EqualTo(expected),
                "Context.And(BigInteger, BitVec) method failed"
            );
        });
    }
    ...
    )
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                model.GetBitVec(resultMethodBigInt),
                Is.EqualTo(expected),
                "BitVec.Or(BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextBitVec),
                Is.EqualTo(expected),
                "Context.Or(BitVec, BitVec) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextRightBigInt),
                Is.EqualTo(expected),
                "Context.Or(BitVec, BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextLeftBigInt),
                Is.EqualTo(expected),
                "Context.Or(BigInteger, BitVec) method failed"
            );
        });
    }
    ...
    )
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                model.GetBitVec(resultMethodBigInt),
                Is.EqualTo(expected),
                "BitVec.Xor(BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextBitVec),
                Is.EqualTo(expected),
                "Context.Xor(BitVec, BitVec) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextRightBigInt),
                Is.EqualTo(expected),
                "Context.Xor(BitVec, BigInteger) method failed"
            );
            Assert.That(
                model.GetBitVec(resultContextLeftBigInt),
                Is.EqualTo(expected),
                "Context.Xor(BigInteger, BitVec) method failed"
            );
        });
    }
