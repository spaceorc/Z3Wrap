...
public class Z3BitVecExprComparisonTests
{
    ...
    public void UnsignedLessThan_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedResult)
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(model.GetBoolValue(resultOperatorBitVec), Is.EqualTo(expectedResult), "BitVec < BitVec operator failed");
            Assert.That(model.GetBoolValue(resultOperatorRightBigInt), Is.EqualTo(expectedResult), "BitVec < BigInteger operator failed");
            Assert.That(model.GetBoolValue(resultOperatorLeftBigInt), Is.EqualTo(expectedResult), "BigInteger < BitVec operator failed");
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedResult), "BitVec.Lt(BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedResult), "BitVec.Lt(BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedResult), "Context.Lt(BitVec, BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedResult), "Context.Lt(BitVec, BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedResult), "Context.Lt(BigInteger, BitVec, signed=false) method failed");
        });
    }
    ...
    public void SignedLessThan_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedUnsigned)
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedSigned), "BitVec.Lt(BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedSigned), "BitVec.Lt(BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedSigned), "Context.Lt(BitVec, BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedSigned), "Context.Lt(BitVec, BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedSigned), "Context.Lt(BigInteger, BitVec, signed=true) method failed");
        });
    }
    ...
    public void UnsignedLessThanOrEqual_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedResult)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(model.GetBoolValue(resultOperatorRightBigInt), Is.EqualTo(expectedResult), "BitVec <= BigInteger operator failed");
            Assert.That(model.GetBoolValue(resultOperatorLeftBigInt), Is.EqualTo(expectedResult), "BigInteger <= BitVec operator failed");
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedResult), "BitVec.Le(BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedResult), "BitVec.Le(BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedResult), "Context.Le(BitVec, BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedResult), "Context.Le(BitVec, BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedResult), "Context.Le(BigInteger, BitVec, signed=false) method failed");
        });
    }
    ...
    public void SignedLessThanOrEqual_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedUnsigned)
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedSigned), "BitVec.Le(BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedSigned), "BitVec.Le(BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedSigned), "Context.Le(BitVec, BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedSigned), "Context.Le(BitVec, BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedSigned), "Context.Le(BigInteger, BitVec, signed=true) method failed");
        });
    }
    ...
    public void UnsignedGreaterThan_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedResult)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(model.GetBoolValue(resultOperatorRightBigInt), Is.EqualTo(expectedResult), "BitVec > BigInteger operator failed");
            Assert.That(model.GetBoolValue(resultOperatorLeftBigInt), Is.EqualTo(expectedResult), "BigInteger > BitVec operator failed");
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedResult), "BitVec.Gt(BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedResult), "BitVec.Gt(BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedResult), "Context.Gt(BitVec, BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedResult), "Context.Gt(BitVec, BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedResult), "Context.Gt(BigInteger, BitVec, signed=false) method failed");
        });
    }
    ...
    public void SignedGreaterThan_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedUnsigned)
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedSigned), "BitVec.Gt(BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedSigned), "BitVec.Gt(BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedSigned), "Context.Gt(BitVec, BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedSigned), "Context.Gt(BitVec, BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedSigned), "Context.Gt(BigInteger, BitVec, signed=true) method failed");
        });
    }
    ...
    public void UnsignedGreaterThanOrEqual_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedResult)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(model.GetBoolValue(resultOperatorRightBigInt), Is.EqualTo(expectedResult), "BitVec >= BigInteger operator failed");
            Assert.That(model.GetBoolValue(resultOperatorLeftBigInt), Is.EqualTo(expectedResult), "BigInteger >= BitVec operator failed");
            Assert.That(model.GetBoolValue(resultMethodBitVec), Is.EqualTo(expectedResult), "BitVec.Ge(BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultMethodBigInt), Is.EqualTo(expectedResult), "BitVec.Ge(BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedResult), "Context.Ge(BitVec, BitVec, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedResult), "Context.Ge(BitVec, BigInteger, signed=false) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedResult), "Context.Ge(BigInteger, BitVec, signed=false) method failed");
        });
    }
    ...
    public void SignedGreaterThanOrEqual_AllVariations_ReturnsExpectedResult(int left, int right, bool expectedUnsigned)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(model.GetBoolValue(resultContextBitVec), Is.EqualTo(expectedSigned), "Context.Ge(BitVec, BitVec, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextRightBigInt), Is.EqualTo(expectedSigned), "Context.Ge(BitVec, BigInteger, signed=true) method failed");
            Assert.That(model.GetBoolValue(resultContextLeftBigInt), Is.EqualTo(expectedSigned), "Context.Ge(BigInteger, BitVec, signed=true) method failed");
        });
    }
