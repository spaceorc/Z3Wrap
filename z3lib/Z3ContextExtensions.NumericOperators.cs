...
public static partial class Z3ContextExtensions
{
    ...
    public static Z3RealExpr Add(this Z3Context context, Z3RealExpr left, int right) => context.Add(left, context.Real(right));
    public static Z3RealExpr Add(this Z3Context context, int left, Z3RealExpr right) => context.Add(context.Real(left), right);
    ...
    public static Z3RealExpr Sub(this Z3Context context, Z3RealExpr left, int right) => context.Sub(left, context.Real(right));
    public static Z3RealExpr Sub(this Z3Context context, int left, Z3RealExpr right) => context.Sub(context.Real(left), right);
    ...
    public static Z3RealExpr Mul(this Z3Context context, Z3RealExpr left, int right) => context.Mul(left, context.Real(right));
    public static Z3RealExpr Mul(this Z3Context context, int left, Z3RealExpr right) => context.Mul(context.Real(left), right);
    ...
    public static Z3RealExpr Div(this Z3Context context, Z3RealExpr left, int right) => context.Div(left, context.Real(right));
    public static Z3RealExpr Div(this Z3Context context, int left, Z3RealExpr right) => context.Div(context.Real(left), right);
