...
public sealed class Z3RealExpr : Z3Expr
{
    ...
    public static Z3BoolExpr operator ==(Z3RealExpr left, int right) => left.Context.Eq(left, right);
    public static Z3BoolExpr operator !=(Z3RealExpr left, int right) => left.Context.Neq(left, right);
    public static Z3BoolExpr operator ==(int left, Z3RealExpr right) => right.Context.Eq(left, right);
    public static Z3BoolExpr operator !=(int left, Z3RealExpr right) => right.Context.Neq(left, right);

    // Z3RealExpr <-> int operations (for convenience: myRealExpr < 10)
    public static Z3RealExpr operator +(Z3RealExpr left, int right) => left.Context.Add(left, right);
    public static Z3RealExpr operator -(Z3RealExpr left, int right) => left.Context.Sub(left, right);
    public static Z3RealExpr operator *(Z3RealExpr left, int right) => left.Context.Mul(left, right);
    public static Z3RealExpr operator /(Z3RealExpr left, int right) => left.Context.Div(left, right);
    public static Z3BoolExpr operator <(Z3RealExpr left, int right) => left.Context.Lt(left, right);
    public static Z3BoolExpr operator <=(Z3RealExpr left, int right) => left.Context.Le(left, right);
    public static Z3BoolExpr operator >(Z3RealExpr left, int right) => left.Context.Gt(left, right);
    public static Z3BoolExpr operator >=(Z3RealExpr left, int right) => left.Context.Ge(left, right);

    // int <-> Z3RealExpr operations
    public static Z3RealExpr operator +(int left, Z3RealExpr right) => right.Context.Add(left, right);
    public static Z3RealExpr operator -(int left, Z3RealExpr right) => right.Context.Sub(left, right);
    public static Z3RealExpr operator *(int left, Z3RealExpr right) => right.Context.Mul(left, right);
    public static Z3RealExpr operator /(int left, Z3RealExpr right) => right.Context.Div(left, right);
    public static Z3BoolExpr operator <(int left, Z3RealExpr right) => right.Context.Lt(left, right);
    public static Z3BoolExpr operator <=(int left, Z3RealExpr right) => right.Context.Le(left, right);
    public static Z3BoolExpr operator >(int left, Z3RealExpr right) => right.Context.Gt(left, right);
    public static Z3BoolExpr operator >=(int left, Z3RealExpr right) => right.Context.Ge(left, right);

    public Z3RealExpr Add(Z3RealExpr other) => Context.Add(this, other);
    public Z3RealExpr Add(double other) => Context.Add(this, other);
    public Z3RealExpr Add(int other) => Context.Add(this, other);

    public Z3RealExpr Sub(Z3RealExpr other) => Context.Sub(this, other);
    public Z3RealExpr Sub(double other) => Context.Sub(this, other);
    public Z3RealExpr Sub(int other) => Context.Sub(this, other);

    public Z3RealExpr Mul(Z3RealExpr other) => Context.Mul(this, other);
    public Z3RealExpr Mul(double other) => Context.Mul(this, other);
    public Z3RealExpr Mul(int other) => Context.Mul(this, other);

    public Z3RealExpr Div(Z3RealExpr other) => Context.Div(this, other);
    public Z3RealExpr Div(double other) => Context.Div(this, other);
    public Z3RealExpr Div(int other) => Context.Div(this, other);
