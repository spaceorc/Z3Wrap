    ...
    where TSize : ISize
{
    ...
    public Z3Bool Lt(Z3BitVec<TSize> other, bool signed = false) => Context.Lt(this, other, signed);
    ...
    /// <param name="signed">Whether to perform signed (true) or unsigned (false) comparison.</param>
    /// <returns>A boolean expression representing this &lt;= other.</returns>
    public Z3Bool Le(Z3BitVec<TSize> other, bool signed = false) => Context.Le(this, other, signed);
    ...
    /// <param name="signed">Whether to perform signed (true) or unsigned (false) comparison.</param>
    /// <returns>A boolean expression representing this &gt; other.</returns>
    public Z3Bool Gt(Z3BitVec<TSize> other, bool signed = false) => Context.Gt(this, other, signed);
    ...
    /// <param name="signed">Whether to perform signed (true) or unsigned (false) comparison.</param>
    /// <returns>A boolean expression representing this &gt;= other.</returns>
    public Z3Bool Ge(Z3BitVec<TSize> other, bool signed = false) => Context.Ge(this, other, signed);
    ...
    public static Z3Bool operator <(Z3BitVec<TSize> left, Z3BitVec<TSize> right) => left.Lt(right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &lt;= right.</returns>
    public static Z3Bool operator <=(Z3BitVec<TSize> left, Z3BitVec<TSize> right) => left.Le(right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &gt; right.</returns>
    public static Z3Bool operator >(Z3BitVec<TSize> left, Z3BitVec<TSize> right) => left.Gt(right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &gt;= right.</returns>
    public static Z3Bool operator >=(Z3BitVec<TSize> left, Z3BitVec<TSize> right) => left.Ge(right);
}
