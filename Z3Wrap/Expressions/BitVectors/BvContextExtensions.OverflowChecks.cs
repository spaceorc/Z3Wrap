...
public static partial class BvContextExtensions
{
    ...
    public static BoolExpr SignedSubNoOverflow<TSize>(
        this Z3Context context,
        BvExpr<TSize> left,
        BvExpr<TSize> right
    )
    ...
    public static BoolExpr SignedMulNoUnderflow<TSize>(
        this Z3Context context,
        BvExpr<TSize> left,
        BvExpr<TSize> right
    )
    ...
    public static BoolExpr SignedAddNoUnderflow<TSize>(
        this Z3Context context,
        BvExpr<TSize> left,
        BvExpr<TSize> right
    )
    ...
    public static BoolExpr SignedDivNoOverflow<TSize>(
        this Z3Context context,
        BvExpr<TSize> left,
        BvExpr<TSize> right
    )
