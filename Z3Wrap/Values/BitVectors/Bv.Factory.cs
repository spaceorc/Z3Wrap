...
public readonly partial struct Bv<TSize>
{
    ...
    /// </summary>
    public static readonly Bv<TSize> Zero = new(0);

    /// <summary>
    /// Creates a bitvector representing one.
    /// </summary>
    public static readonly Bv<TSize> One = new(1);

    /// <summary>
    /// Creates a bitvector with the maximum possible value (all bits set to 1).
    /// </summary>
    public static readonly Bv<TSize> Max = new((BigInteger.One << (int)Size) - 1);

    /// <summary>
    /// Creates a bitvector with only the sign bit set (most significant bit).
    /// </summary>
    public static readonly Bv<TSize> SignBit = new(BigInteger.One << ((int)Size - 1));

    /// <summary>
    /// Creates a bitvector with all bits set to 1 (alias for Max).
    /// </summary>
    public static readonly Bv<TSize> AllOnes = Max;
    ...
    public static Bv<TSize> FromBytes(ReadOnlySpan<byte> bytes)
    {
    ...
    public static Bv<TSize> FromHex(string hex)
    {
    ...
    public static Bv<TSize> FromBinary(string binary)
    {
