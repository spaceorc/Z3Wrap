...
public sealed partial class Z3Library2
{
    ...
    public IntPtr OptimizeGetReasonUnknown(IntPtr c, IntPtr d)
    {
        ...
        CheckError(c);
        return CheckHandle(result, nameof(OptimizeGetReasonUnknown));
    }
    ...
    public IntPtr OptimizeToString(IntPtr c, IntPtr o)
    {
        ...
        CheckError(c);
        return CheckHandle(result, nameof(OptimizeToString));
    }
    ...
    public IntPtr OptimizeGetHelp(IntPtr c, IntPtr t)
    {
        ...
        CheckError(c);
        return CheckHandle(result, nameof(OptimizeGetHelp));
    }
