...
public sealed partial class Z3Library2
{
    ...
    /// , and Z3_STRING_SYMBOL if the symbol
    ...
    /// be automatically deallocated when
    /// <see cref="DelContext"/>
    /// is invoked.
    ...
    public IntPtr GetSymbolString(IntPtr c, IntPtr s)
    {
        ...
        CheckError(c);
        return CheckHandle(result, nameof(GetSymbolString));
    }
    ...
    /// </remarks>
    public IntPtr GetDeclRationalParameter(IntPtr c, IntPtr d, uint idx)
    {
        var result = nativeLibrary.GetDeclRationalParameter(c, d, idx);
        CheckError(c);
        return CheckHandle(result, nameof(GetDeclRationalParameter));
    }
    ...
    /// </remarks>
    public IntPtr GetNumeralString(IntPtr c, IntPtr a)
    {
        var result = nativeLibrary.GetNumeralString(c, a);
        CheckError(c);
        return CheckHandle(result, nameof(GetNumeralString));
    }
    ...
    /// </remarks>
    public IntPtr GetNumeralBinaryString(IntPtr c, IntPtr a)
    {
        var result = nativeLibrary.GetNumeralBinaryString(c, a);
        CheckError(c);
        return CheckHandle(result, nameof(GetNumeralBinaryString));
    }
    ...
    /// </remarks>
    public IntPtr GetNumeralDecimalString(IntPtr c, IntPtr a, uint precision)
    {
        var result = nativeLibrary.GetNumeralDecimalString(c, a, precision);
        CheckError(c);
        return CheckHandle(result, nameof(GetNumeralDecimalString));
    }
    ...
    public IntPtr SimplifyGetHelp(IntPtr c)
    {
        ...
        CheckError(c);
        return CheckHandle(result, nameof(SimplifyGetHelp));
    }
