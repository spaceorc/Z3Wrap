...
public static partial class Z3ContextExtensions
{
    ...
    public static Z3IntExpr Abs(this Z3Context context, Z3IntExpr expr)
    {
        return context.Ite(expr < 0, -expr, expr);
    }

    public static Z3RealExpr Abs(this Z3Context context, Z3RealExpr expr)
    {
        return context.Ite(expr < 0, -expr, expr);
    }
