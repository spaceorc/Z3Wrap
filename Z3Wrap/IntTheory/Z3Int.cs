...
public sealed class Z3Int : Z3NumericExpr, IZ3ExprType<Z3Int>
{
    ...
    public static Z3Int operator +(Z3Int left, Z3Int right) => left.Context.Add(left, right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>An integer expression representing left - right.</returns>
    public static Z3Int operator -(Z3Int left, Z3Int right) => left.Context.Sub(left, right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>An integer expression representing left * right.</returns>
    public static Z3Int operator *(Z3Int left, Z3Int right) => left.Context.Mul(left, right);
    ...
    /// <returns>An integer expression representing left / right.</returns>
    public static Z3Int operator /(Z3Int left, Z3Int right) => left.Context.Div(left, right);
    ...
    /// <param name="right">The right operand (divisor).</param>
    /// <returns>An integer expression representing left % right.</returns>
    public static Z3Int operator %(Z3Int left, Z3Int right) => left.Context.Mod(left, right);
    ...
    public static Z3Bool operator <(Z3Int left, Z3Int right) => left.Context.Lt(left, right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &lt;= right.</returns>
    public static Z3Bool operator <=(Z3Int left, Z3Int right) => left.Context.Le(left, right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &gt; right.</returns>
    public static Z3Bool operator >(Z3Int left, Z3Int right) => left.Context.Gt(left, right);
    ...
    /// <param name="right">The right operand.</param>
    /// <returns>A boolean expression representing left &gt;= right.</returns>
    public static Z3Bool operator >=(Z3Int left, Z3Int right) => left.Context.Ge(left, right);
    ...
    /// <returns>A boolean expression representing left == right.</returns>
    public static Z3Bool operator ==(Z3Int left, BigInteger right) => left.Context.Eq(left, right);
    ...
    /// <param name="right">The BigInteger value.</param>
    /// <returns>A boolean expression representing left != right.</returns>
    public static Z3Bool operator !=(Z3Int left, BigInteger right) => left.Context.Neq(left, right);
    ...
    /// <returns>A boolean expression representing left == right.</returns>
    public static Z3Bool operator ==(BigInteger left, Z3Int right) => right.Context.Eq(left, right);
